(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[665],{45652:(e,t,a)=>{var r=a(88668),l=a(47443),i=a(1196),n=a(74757),o=a(23593),s=a(21814);e.exports=function(e,t,a){var d=-1,c=l,u=e.length,p=!0,m=[],h=m;if(a)p=!1,c=i;else if(u>=200){var g=t?null:o(e);if(g)return s(g);p=!1,c=n,h=new r}else h=t?[]:m;e:for(;++d<u;){var b=e[d],f=t?t(b):b;if(b=a||0!==b?b:0,p&&f==f){for(var v=h.length;v--;)if(h[v]===f)continue e;t&&h.push(f),m.push(b)}else c(h,f,a)||(h!==m&&h.push(f),m.push(b))}return m}},23593:(e,t,a)=>{var r=a(58525),l=a(50308),i=a(21814),n=r&&1/i(new r([,-0]))[1]==1/0?function(e){return new r(e)}:l;e.exports=n},45578:(e,t,a)=>{var r=a(67206),l=a(45652);e.exports=function(e,t){return e&&e.length?l(e,r(t,2)):[]}},26996:(e,t,a)=>{"use strict";a.d(t,{Z:()=>f});var r=a(67294),l=a(51995),i=a(61988),n=a(35932),o=a(74069),s=a(4715),d=a(34858),c=a(29487),u=a(11965);const p=(0,d.z)(),m=p?p.support:"https://superset.apache.org/docs/databases/installing-database-drivers",h=({errorMessage:e,showDbInstallInstructions:t})=>(0,u.tZ)(c.Z,{closable:!1,css:e=>(e=>u.iv`
...
`,f=({resourceName:e,resourceLabel:t,passwordsNeededMessage:a,confirmOverwriteMessage:l,onModelImport:c,show:p,onHide:m,passwordFields:f=[],setPasswordFields:v=(()=>{})})=>{const[y,Z]=(0,r.useState)(!0),[w,_]=(0,r.useState)({}),[x,S]=(0,r.useState)(!1),[C,$]=(0,r.useState)(!1),[E,T]=(0,r.useState)([]),[k,I]=(0,r.useState)(!1),[N,A]=(0,r.useState)(),z=()=>{T([]),v([]),_({}),S(!1),$(!1),I(!1),A("")},{state:{alreadyExists:F,passwordsNeeded:H},importResource:D}=(0,d.PW)(e,t,(e=>{A(e)}));(0,r.useEffect)((()=>{v(H),H.length>0&&I(!1)}),[H,v]),(0,r.useEffect)((()=>{S(F.length>0),F.length>0&&I(!1)}),[F,S]);return y&&p&&Z(!1),(0,u.tZ)(o.Z,{name:"model",className:"import-model-modal",disablePrimaryButton:0===E.length||x&&!C||k,onHandledPrimaryAction:()=>{var e;(null==(e=E[0])?void 0:e.originFileObj)instanceof File&&(I(!0),D(E[0].originFileObj,w,C).then((e=>{e&&(z(),c())})))},onHide:()=>{Z(!0),m(),z()},primaryButtonName:x?(0,i.t)("Overwrite"):(0,i.t)("Import"),primaryButtonType:x?"danger":"primary",width:"750px",show:p,title:(0,u.tZ)("h4",null,(0,i.t)("Import %s",t))},(0,u.tZ)(b,null,(0,u.tZ)(s.gq,{name:"modelFile",id:"modelFile","data-test":"model-file-input",accept:".yaml,.json,.yml,.zip",fileList:E,onChange:e=>{T([{...e.file,status:"done"}])},onRemove:e=>(T(E.filter((t=>t.uid!==e.uid))),!1),customRequest:()=>{},disabled:k},(0,u.tZ)(n.Z,{loading:k},"Select file"))),N&&(0,u.tZ)(h,{errorMessage:N,showDbInstallInstructions:f.length>0}),0===f.length?null:(0,u.tZ)(r.Fragment,null,(0,u.tZ)("h5",null,"Database passwords"),(0,u.tZ)(g,null,a),f.map((e=>(0,u.tZ)(b,{key:`password-for-${e}`},(0,u.tZ)("div",{className:"control-label"},e,(0,u.tZ)("span",{className:"required"},"*")),(0,u.tZ)("input",{name:`password-${e}`,autoComplete:`password-${e}`,type:"password",value:w[e],onChange:t=>_({...w,[e]:t.target.value})}))))),x?(0,u.tZ)(r.Fragment,null,(0,u.tZ)(b,null,(0,u.tZ)("div",{className:"confirm-overwrite"},l),(0,u.tZ)("div",{className:"control-label"},(0,i.t)('Type "%s" to confirm',(0,i.t)("OVERWRITE"))),(0,u.tZ)("input",{"data-test":"overwrite-modal-input",id:"overwrite",type:"text",onChange:e=>{var t,a;const r=null!=(t=null==(a=e.currentTarget)?void 0:a.value)?t:"";$(r.toUpperCase()===(0,i.t)("OVERWRITE"))}}))):null)}},13434:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>P});var r=a(45578),l=a.n(r),i=a(51995),n=a(61988),o=a(11064),s=a(31069),d=a(67294),c=a(15926),u=a.n(c),p=a(30381),m=a.n(p),h=a(91877),g=a(93185),b=a(40768),f=a(34858),v=a(32228),y=a(19259),Z=a(20755),w=a(36674),_=a(18782),x=a(38703),S=a(61337),C=a(14114),$=a(83673),E=a(26996),T=a(58593),k=a(70163),I=a(1510),N=a(49986),A=a(8272),z=a(79789),F=a(85156),H=a(34024),D=a(11965);const M=i.iK.div`
  align-items: center;
  display: flex;
